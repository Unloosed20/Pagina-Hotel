...
const GestionRestaurante = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      tipo: formData.tipo,
      precio_copa:
        formData.tipo === "Bebida" ? parseFloat(formData.precio_copa) : null,
      numero_copas_botella:
  ...
  return (
    <div className="container">
      ...
      {/* Sección Pedidos */}
      <section className="pedidos-section" style={{ marginTop: "40px" }}>
        <h2>Pedidos</h2>
        <table className="client-table" style={{ width: "100%" }}>
          <thead>
            <tr>
